   ...
   class betstar : public contract {
      ...
      private:
         ...
         struct part_info {
            ...
            EOSLIB_SERIALIZE( part_info, (participant)(star)(quantity) )
         };
         ...
         struct multi_winner {
            ...
            EOSLIB_SERIALIZE( multi_winner, (participant)(count) )
         };
         ...
         typedef eosio::multi_index<N(issue), issue> issues;
         typedef eosio::multi_index<N(term), term> terms;
         typedef eosio::singleton<N(config), bet_config> config;
